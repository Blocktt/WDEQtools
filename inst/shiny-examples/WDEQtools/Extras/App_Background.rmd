...
In addition, a diatom IBI provides an accurate assessment of ecological effects on a third assemblage in Wyoming, which might respond to different stressors than those indicated by the existing fish and macroinvertebrate assemblages, thus improving WDEQ’s diagnostic ability to identify causes of degradation in water quality. Diatoms are typically associated with nutrient availability ([Charles et al. 2019](https://www.sciencedirect.com/science/article/abs/pii/S1470160X18306496)) and the diatom IBI might be useful to evaluate direct biological responses to excessive nutrients.

Streams sampled by the diatom monitoring program were wadeable and perennial. All diatom samples used in the analyses were collected by WDEQ field staff according to the WDEQ Manual of Standard Operating Procedures ([WDEQ 2021](https://deq.wyoming.gov/water-quality/watershed-protection/water-quality-assessment/)). Periphyton samples are collected during low flow, from late July through October. If the user applies the indices to samples that do not meet the criteria listed above, results should be interpreted with caution. For more information on sampling methodologies and application limits, see the IBI development reports [here](https://github.com/Blocktt/ShinyAppDocuments/tree/main/WDEQtools/Reports).
