...
The diatom IBI calibration project resulted in an index applicable statewide. Four metrics are adjusted by eight different factors (see Metric Adjustment Download Tab) that represent natural stream types.Reports detailing the development of the diatom IBI can be found [here](https://github.com/Blocktt/ShinyAppDocuments/tree/main/WDEQtools/Reports).

## Intended application
The purpose of the index is to describe the diatom community of Wyoming freshwater streams for the purpose of biological condition assessment. A diatom IBI enhances the state of Wyoming’s monitoring and assessment strategy by adding a numeric indicator of diatom community structure that could be used to assess aquatic life use in:
